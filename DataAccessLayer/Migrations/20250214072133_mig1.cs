            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NotificationtType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotificationtTypeSymbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotificationtDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotificationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NotificationtStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
